...
execute if score 0 hmmm_temp matches 1 run function hmmm:extended_float/32/exponential/floor_nonzero
...
# This is ln(2)(x-0.5). Save it to hmmm_temp.[14..16]
...
# Save a copy (^ to the ith power) to hmmm_temp.[17..19] (insert later)

# Set hmmm_temp.[20..22] as the accumulator (begins at 1) (insert later)

# degree 1: Just add hmmm_temp.[14..16] and 1
scoreboard players operation P0 hmmm_io = 14 hmmm_temp
scoreboard players operation P1 hmmm_io = 15 hmmm_temp
scoreboard players operation P2 hmmm_io = 16 hmmm_temp
...
# Divide by two and add it to accumulator hmmm_temp.[9..11] (bitshift right)
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
# bitshift right
...
scoreboard players operation P3 hmmm_io = 20 hmmm_temp
scoreboard players operation P4 hmmm_io = 21 hmmm_temp
scoreboard players operation P5 hmmm_io = 22 hmmm_temp
...
# Save this to hmmm_temp.[6..8]
scoreboard players operation 17 hmmm_temp = R0 hmmm_io
scoreboard players operation 18 hmmm_temp = R1 hmmm_io
scoreboard players operation 19 hmmm_temp = R2 hmmm_io

# Divide by 3! and add it to accumulator hmmm_temp.[9..11]
# divide by six
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
scoreboard players operation P2 hmmm_io = R2 hmmm_io
...
# Divide by 4! and add it to accumulator hmmm_temp.[9..11]
# divide by 24
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
scoreboard players operation P2 hmmm_io = R2 hmmm_io
...
# Divide by 5! and add it to accumulator hmmm_temp.[9..11]
# divide by five
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
scoreboard players operation P2 hmmm_io = R2 hmmm_io
...
# Divide by 6! and add it to accumulator hmmm_temp.[9..11]
# divide by 720
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
scoreboard players operation P2 hmmm_io = R2 hmmm_io
...
# Divide by 7! and add it to accumulator hmmm_temp.[9..11]
# divide by 
scoreboard players operation P0 hmmm_io = R0 hmmm_io
scoreboard players operation P1 hmmm_io = R1 hmmm_io
scoreboard players operation P2 hmmm_io = R2 hmmm_io
