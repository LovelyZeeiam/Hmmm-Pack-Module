...
scoreboard players set R0 hmmm_io 5
execute if score P1 hmmm_io matches 128 run function hmmm:float/32/check_type/dne
execute if score P1 hmmm_io matches -127 if score P2 hmmm_io matches 0 run function hmmm:float/32/check_type/zero