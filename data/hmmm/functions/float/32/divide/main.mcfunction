...
execute if score 8 hmmm_temp matches 1 run function hmmm:float/32/divide/exception/nan
execute if score 8 hmmm_temp matches 0 run function hmmm:float/32/divide/branch0
