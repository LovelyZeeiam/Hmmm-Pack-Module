...
# overflow
execute if score 1 temp matches 129.. run function hmmm:float/32/divide/exception/overflow
# underflow
execute if score 1 temp matches ..-128 run function hmmm:float/32/divide/exception/underflow

# if working
execute if score 8 temp matches 0 run function hmmm:float/32/divide/branch210