...
execute unless score 4 temp matches 0 unless score 4 temp matches 2 run function hmmm:float/32/divide/branch2103
execute unless score 4 temp matches 0 unless score 4 temp matches 1 run function hmmm:float/32/divide/branch2104
...
execute if score R2 io matches ..8388608 run function hmmm:float/32/divide/branch2101
execute if score 0 temp >= 1 temp run scoreboard players add R2 io 1

# fix denormalized numbers
execute if score R1 io matches ..-127 run function hmmm:float/32/divide/branch2105
# return 0 if number is very small
execute if score R1 io matches ..-127 run function hmmm:float/32/divide/branch1
# return infinity if number is very large
execute if score R1 io matches 129.. run function hmmm:float/32/divide/branch20
...
execute if score R2 io matches 8388608.. run function hmmm:float/32/divide/branch2106