...
execute if score 0 temp >= 1 temp run scoreboard players add R2 hmmm_io 1
...
execute if score 8 temp matches 0 if score R1 hmmm_io matches -126 unless score R0 hmmm_io matches 8388608.. run scoreboard players set R1 hmmm_io -127

# remove implicit bit
execute if score 8 temp matches 0 if score R1 hmmm_io matches -126.. run scoreboard players remove R2 hmmm_io 8388608
