...
execute if score R2 io matches ..-1 run function hmmm:float/32/add/branch1112


# if sum of significands are 0, output 0
execute if score R2 io matches 0 run function hmmm:float/32/add/branch1110

# check for significand overflow
execute unless score R2 io matches 0 run function hmmm:float/32/add/branch1111
