#> hmmm:bitwise/float/32/add/branch111
# exponents are equal
...
execute if score R2 io matches ..-1 run function hmmm:bitwise/float/32/add/branch1112


# if sum of significands are 0, output 0
execute if score R2 io matches 0 run function hmmm:bitwise/float/32/add/branch1110

# check for significand overflow
execute unless score R2 io matches 0 run function hmmm:bitwise/float/32/add/branch1111
