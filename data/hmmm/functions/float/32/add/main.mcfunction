...
scoreboard players operation 3 temp = P2 hmmm_io

scoreboard players operation 4 temp = P3 hmmm_io
scoreboard players operation 5 temp = P4 hmmm_io
scoreboard players operation 6 temp = P5 hmmm_io
scoreboard players operation 7 temp = P5 hmmm_io
