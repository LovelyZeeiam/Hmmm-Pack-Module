#> hmmm:bitwise/float/32/add/branch1
##
...
execute if score R0 io matches 3..4 run function hmmm:bitwise/float/32/add/branch10

# If F0 is an infinity, check if F1 a different infinity. Otherwise return F0
execute if score 8 temp matches 0 if score 9 temp matches 1..2 run function hmmm:bitwise/float/32/add/branch2
execute if score 8 temp matches 0 if score 10 temp matches 1..2 run function hmmm:bitwise/float/32/add/branch3


# other case
execute if score 8 temp matches 0 run function hmmm:bitwise/float/32/add/branch11