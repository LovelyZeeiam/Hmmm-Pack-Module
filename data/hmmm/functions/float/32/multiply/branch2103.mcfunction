...
execute if score 8 temp matches 0 if score R1 hmmm_io matches -125.. unless score R2 hmmm_io matches 8388608.. run function hmmm:float/32/multiply/branch2103