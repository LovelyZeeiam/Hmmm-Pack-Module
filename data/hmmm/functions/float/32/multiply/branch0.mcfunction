...
execute if score 8 temp matches 1 run function hmmm:float/32/multiply/branch1
execute if score 8 temp matches 0 run function hmmm:float/32/multiply/branch2