...
function hmmm:bitwise/float/32/compare/greater_equal/main

# if it is greater, set to positive infinity
execute if score R0 io matches 1 run function hmmm:bitwise/extended_float/32/exponential/pos_inf
