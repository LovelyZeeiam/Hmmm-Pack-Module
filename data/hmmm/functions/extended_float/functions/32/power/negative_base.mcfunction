#> hmmm:bitwise/extended_float/32/power/negative_base
...
execute if score 3 temp matches 2 run function hmmm:bitwise/extended_float/32/power/nan
execute if score 3 temp matches 0..1 run function hmmm:bitwise/extended_float/32/power/int
