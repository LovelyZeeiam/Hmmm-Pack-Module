...
execute if score 0 temp matches 1 if score P0 io matches 0 run function hmmm:bitwise/extended_float/32/power/positive_base
execute if score 0 temp matches 1 run function hmmm:bitwise/extended_float/32/root/negative_radicand