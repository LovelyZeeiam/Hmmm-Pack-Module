#> hmmm:bitwise/extended_float/32/root/negative_radicand
...
execute unless score 3 temp matches 1 run function hmmm:bitwise/extended_float/32/power/nan
execute if score 3 temp matches 1 run function hmmm:bitwise/extended_float/32/power/int
