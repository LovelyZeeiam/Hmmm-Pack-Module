...
execute if score P1 io matches 0 run function hmmm:extended_float/32/float_type/one
execute if score P1 io matches 1..22 run function hmmm:extended_float/32/float_type/possible_integer