...
execute if score P1 io matches 1.. run function hmmm:extended_float/32/truncate/b/main
execute if score P2 io matches 1.. run scoreboard players set R0 io 2


execute if score R0 io matches 0 run function hmmm:extended_float/32/float_type/pi_not_invalid