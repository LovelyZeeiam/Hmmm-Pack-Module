...
#       32-bit sign, 32-bit exponent, 32-bit significand
#
# @modifies hmmm_temp.[11..16]

scoreboard players set 11 hmmm_temp 1
...
execute if score 11 hmmm_temp matches 1 run function hmmm:extended_float/32/fast_inverse_sqrt/positive