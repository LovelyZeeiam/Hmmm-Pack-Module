...
execute if score 0 temp matches 1 if score R0 hmmm_io matches 1 if score P1 hmmm_io matches ..22 unless score P2 hmmm_io matches 0 run function hmmm:extended_float/32/floor/sub_1