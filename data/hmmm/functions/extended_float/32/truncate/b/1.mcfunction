execute if score P1 io matches 1..2 run function hmmm:extended_float/32/truncate/b/5
...
execute if score P1 io matches 5..6 run function hmmm:extended_float/32/truncate/b/8
