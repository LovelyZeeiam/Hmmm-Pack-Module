...
execute if score 11 temp matches 1 run function hmmm:extended_float/32/exponential/negative

# Exponent is in range:
execute if score 11 temp matches 0..1 run function hmmm:extended_float/32/exponential/in_range