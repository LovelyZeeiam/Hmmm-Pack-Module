...
scoreboard players operation R0 hmmm_io += 1 temp
...
execute if score 0 temp >= P1 hmmm_io run scoreboard players set 2 temp 1
execute if score 2 temp matches 1 run function hmmm:bitwise/32/unsigned/divmod/b010

scoreboard players operation R1 hmmm_io += 0 temp
scoreboard players set 2 temp 0
execute if score R1 hmmm_io matches ..-1 run scoreboard players set 2 temp 1
execute if score R1 hmmm_io >= P1 hmmm_io run scoreboard players set 2 temp 1
