...
## execute if score 0 temp matches 1 run function hmmm:extended_float/32/power/integer_exponent/main
    ...
    scoreboard players set 0 temp 1
    # execute if score P4 io matches ..-1 run function hmmm:extended_float/32/power/integer_exponent/zero
    ##execute if score 0 temp matches 1 if score P3 io matches 1 run function hmmm:extended_float/32/power/integer_exponent/negative
        ...
        ## function hmmm:extended_float/32/power/integer_exponent/main
            ...
            execute if score P4 io matches ..-1 run function hmmm:extended_float/32/power/integer_exponent/zero
            execute if score 0 temp matches 1 if score P3 io matches 1 run function hmmm:extended_float/32/power/integer_exponent/negative
            execute if score 0 temp matches 1 if score P4 io matches 0 run function hmmm:extended_float/32/power/integer_exponent/one
            ## execute if score 0 temp matches 1 run function hmmm:extended_float/32/power/integer_exponent/check_even
                ...
                execute if score R0 io matches 0 run function hmmm:extended_float/32/power/integer_exponent/even
                ## execute if score 0 temp matches 1 if score R0 io matches 1 run function hmmm:extended_float/32/power/integer_exponent/odd
